class Warehouse:
    ...
    def valid(department, types, name, amount):
        if department == 'Первое' or department == 'Второе' or department == 'Третье':
            if types == 'Принтеры' or types == 'Сканеры' or types == 'Ксероксы':
...
print(deliver)
print(base_1)
sale = base_1.sale('Второе', 'Принтеры', 'Canon', 50)
print(sale)
print(base_1)
